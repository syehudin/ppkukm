                ...
                <div class="panel-header bg-primary-gradient">
                    <div class="page-inner py-5">
                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            <div>
                                <h2 class="text-white pb-2 fw-bold">Data Transaksi QRIS</h2>
                                <h5 class="text-white op-7 mb-2">Data Transaksi QRIS paling tertinggi dalam 1 tahun di 2023</h5>
                            </div>
                    ...
                    <div class="row mt--2">
                        <div class="col-md-12">
                            <div class="card full-height">
                                <div class="card-body">
                                    <h2>Tabel Data Transaksi QRIS</h2><br>
                                            ...
                                            <?php
                                                ...
                                                foreach ($datas as $data => $i) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php echo $i['nama_event']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $i['jadwal_pelaksanaan_mulai']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $i['jadwal_pelaksanaan_selesai']; ?>
                                                        </td>
                                                        <td>
